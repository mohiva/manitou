...
/**
 * Exception class that signals that a abstract class method cannot contain body.
 *
 * @category  Mohiva/Manitou
 * @package   Mohiva/Manitou/Exceptions
 * @author    Christian Kaps <christian.kaps@mohiva.com>
 ...
 * @link      https://github.com/mohiva/manitou
 */
class AbstractClassMethodContainsBodyException extends SyntaxErrorException {}
