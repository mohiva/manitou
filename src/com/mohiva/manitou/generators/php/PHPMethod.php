...
class PHPMethod extends PHPMember {
	 ...
	 * @return PHPMemberMethod This object instance to provide a fluent interface.
	 */
	 ...
	 * @throws UnexpectedScopeException if an unexpected scope value was given.
	 */
	 ...
	 * @throws FinalAbstractClassMethodException if an abstract method uses final keyword.
	 * @throws StaticAbstractClassMethodException if an abstract method uses static keyword.
	 * @throws AbstractClassMethodContainsBodyException if an abstract method contains body.
	 */
	protected function generateClassMethod() {
		...
		$code .= $this->body ? self::LINE_FEED : '';
		$code .= $this->generateBody();
		$code .= $this->isAbstract ? self::LINE_FEED : '}' . self::LINE_FEED;
	 ...
	 * @throws AbstractInterfaceMethodException if an interface method uses abstract keyword.
	 * @throws FinalInterfaceMethodException if an interface method uses final keyword.
	 * @throws InterfaceMethodContainsBodyException if an interface method contains body.
	 */
	protected function generateInterfaceMethod() {
		...
		$code .= $visibility . ' ';
		$code .= $this->isStatic ? 'static ' : '';
		$code .= 'function ' . $this->name . '(' . $this->generateParameterList() . ');' . self::LINE_FEED;
	...
	protected function generateBody() {
		...
		$body  = self::LINE_FEED;
		$body .= rtrim($this->body->generate(), self::LINE_FEED);
		$body .= self::LINE_FEED;
