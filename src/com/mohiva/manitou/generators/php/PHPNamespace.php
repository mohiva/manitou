...
class PHPNamespace extends Generator {
	 ...
	 * @throws GlobalNamespaceWithoutBracesException if the namespace is global and no braces are used.
	 */
	...
	/**
	 * Generate a namespace definition with braces. The definition consits 
	 * of the namespace definition itself and additionally of use staments, 
	 * classes and interfaces.
	 * 
	 * @return string The complete namespace definition containing additionally use staments, classes and interfaces.
	 */
	...
	/**
	 * Generate a namespace definition without braces. The definition consits 
	 * of the namespace definition itself and additionally of use staments 
	 * and classes.
	 * 
	 * @return string The complete namespace definition containing additionally use staments and classes.
	 */	
	protected function generateNamespaceWithoutBraces() {
		
		$code  = 'namespace ' . $this->name . ';' . self::LINE_FEED;
	 ...
	 * 
	 * @return string The content of all set use statments or an empty string if no use statements are set.
	 */
