...
class PHPFile extends Generator {
	 ...
	 * @throws \com\mohiva\manitou\exceptions\FileGenerationException if namespaces and classes are set for this file.
	 */
