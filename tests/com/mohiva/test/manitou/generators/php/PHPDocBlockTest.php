...
class PHPDocBlockTest extends AbstractGenerator {
	...
	public function testGenerateComplexComment() {
		...
		$license  = 'This source file is subject to the new BSD license that is bundled' . Generator::LINE_FEED;
		$license .= 'with this package in the file LICENSE.txt.' . Generator::LINE_FEED;
		$license .= 'It is also available through the world-wide-web at this URL:' . Generator::LINE_FEED;
		$license .= 'http://framework.mohiva.com/license' . Generator::LINE_FEED;
		$license .= 'If you did not receive a copy of the license and are unable to' . Generator::LINE_FEED;
		$license .= 'obtain it through the world-wide-web, please send an email' . Generator::LINE_FEED;
		$license .= 'to license@framework.mohiva.com so we can send you a copy immediately.' . Generator::LINE_FEED;
